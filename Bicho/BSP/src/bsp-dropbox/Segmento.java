...
public class Segmento {
    ...
    public void adicionaPequenaVariacao(){
        this.linha.setLine(linha.getX1()+0.01,linha.getY1()+0.02,linha.getX2()+0.04,linha.getY2()+0.03);
    }
    ...
    public ArrayList<Poligono> checarInterseccao(Segmento seg1, Segmento seg2) throws NullPointerException{
        if (!seg1.linha.intersectsLine(seg2.linha)) {
            ...
            while(i == null){
                seg1.adicionaPequenaVariacao();
                i = getIntersection(seg1.linha, seg2.linha);
                seg2.adicionaPequenaVariacao();
            }
